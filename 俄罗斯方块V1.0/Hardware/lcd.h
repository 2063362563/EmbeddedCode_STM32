...
void LCD_ShowSingleHZ(u16 x,u16 y,const u8 *pcStr,CHN_font_t font);			//显示一个汉字
void LCD_ShowHZ_ASCIIString(u16 x, u16 y,  u8 *pcStr, CHN_font_t font);		//显示汉字与ASCII字符串
void Fill_LCD_Block(int x, int y, int color);								//在棋盘上指定位置显示一个方块,xy是相对棋盘的位置
